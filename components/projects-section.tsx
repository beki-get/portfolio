...
const projects = [
  {
    ...
    description: 'A full-stack e-commerce solution with authentication, order management, and admin dashboard.',
    image: 'https://res.cloudinary.com/do2hzkidl/image/upload/v1757774522/11_gb5ehq.png',
    tech: ['React', 'JWT authentication','MongoDB', 'Tailwind CSS'],
    category: 'Full Stack',
